...
> The `[T any]` below is Go generics syntax. `T` is a type parameter — the compiler fills it in based on usage. Full explanation in [Topic 10: Generics](../05-generics/10-generics.md).
